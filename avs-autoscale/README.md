...
4.  In the Edit PowerShell Runbook window, copy the Scale-Out PowerShell Runbook code from the code repository into the main code screen without modification. Then select Save and Publish.
...
11. Repeat tasks 1 to 10 for the Scale-In PowerShell Runbook.
